        ...
        if DirMetaDataUser['Nombre'] == 'V':
            ...
            if Existe == 'Si':
                ...
                if EsInsertable == 'Si':
                    ...
                    alerta = str(DescripcionUser)  + 'Proyecto: ' + str(dataValor['project-id']) + '-' + str(dataValor['project-name']) + ' Usuario : ' + str(DirMetaDataUser['Nombre']) + ' ' + str(DirMetaDataUser['Apellidos']) + ' Dia:' +  str(FechaJsonArrays[0]) + ' Horas :' +  str(HorasReal) + ' Porcentaje: ' + str(PorcentajeF)
                    print(alerta)
