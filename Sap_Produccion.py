    ...
    for dataValor in datajsonTiempo['time-entries']:
        ...
        if Existe == 'Si':
            ...
            if EsInsertable == 'Si':
                ...
                alerta = 'Proyecto: ' + str(dataValor['project-id']) + '-' + str(dataValor['project-name']) + ' Usuario : ' + str(DirMetaDataUser['Nombre']) + ' ' + str(DirMetaDataUser['Apellidos']) + ' Dia:' +  str(FechaJsonArrays[0]) + ' Horas :' +  str(HorasReal)
                print(alerta)
