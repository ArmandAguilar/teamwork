            ...
            for dataValor in datajsonTask['todo-items']:
                ...
                if dataValor.get('responsible-party-id') is None:
                    ...
                    if Accion == "Update":
                        ...
                        va = 0
                        Sql = 'INSERT INTO [SAP].[dbo].[AATareasTeamWork] VALUES (\'' + str(ProyectoArray[0]) + '\',\'' + str(IdUsuario) + '\',\'' + dataValor['id'] + '\',\'' + str(TaskWords) + '\',\'' + unicode(AFI) + '\',\'FechaProgramada\',\'FechaFinal\',\'Avance\',\'EtiqFase\',\'EtiqDocumento\',\'EtiqDiciplica\',\'TiempoEstimado\',\'Evaluada\')'
                        #procesar_mssql(Sql)
                        print(Sql)
        Paginado += 1
print('#################################### Insert Task ############################')
