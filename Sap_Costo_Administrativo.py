                ...
                if DirMetaDataUser['Nombre'] == 'V':
                    ...
                    if Existe == 'Si':
                        ...
                        if str(dataValor['todo-item-id']) == '10161660':
                            ...
                            print(str(DirMetaDataUser['IdUsuario']) + str(FechaJsonArrays[0]) + str(PorcentajeF))
                            if str(EsInsertable) == 'Si':
                                ...
                                print(alerta)
                                #alerta = 'Proyecto: ' + str(dataValor['project-id']) + '-' + str(dataValor['project-name']) + ' Usuario : ' + str(DirMetaDataUser['Nombre']) + ' ' + str(DirMetaDataUser['Apellidos']) + ' Dia:' +  str(FechaJsonArrays[0])
                                #print(alerta)
